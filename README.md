...
---
Utilisation
Ouvrir `DrawingVol.html` dans un navigateur (Chrome ou Firefox recommandé)
Choisir la forme avec les boutons ○ ⌓ 3 4 5 6
Ajuster les dimensions avec les sliders
Double-cliquer sur une face pour importer un SVG
Ajuster la position et le zoom du dessin
Cliquer sur ↓ Exporter SVG A3
...
---
Licence
© Martial Rossignol — Licence CC BY-NC-SA 4.0
